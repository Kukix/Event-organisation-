...
namespace Shpping_Order
{
    ...
    class DBconnectionOrder
    {
        ...
        //this method will let you get the user ID by his or her name.
        ...
        //this method will let you get the shop ID by its name.
        ...
        //this method will update the databse after taking an order.
        public int AddOrder(string username)
        {
            ...
            try
            {
                ...
                MySqlCommand command = new MySqlCommand("INSERT INTO `order` values(" + "null" + "," + userID + "," + shopID + ",'" + Myorder.TotalPrice + "','" + DateTime.Now.ToLongDateString() + DateTime.Now.ToLongTimeString() + "')", connection);
