  ...
  <div id="right_container">
	...
	<h4>
			<form name="loginForm">
				<div class="right">
					Message:<br/>
					<textarea name="message" cols="30" rows="20" placeholder="Enter your message here."></textarea>
				</div>
				<div class="right">
				<input type="text" name="name" placeholder="Enter your name"></input><br />
				<input type="email" name="email" placeholder="Enter your e-mail"></input><br />
				<input type="text" name="subject" placeholder="Enter subject"></input><br />
				</div>
				Your Name:<br />
				Your Email:<br />
				Subject:<br />
